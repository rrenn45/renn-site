...
export default function Home() {
  return (<><h1 className="text-3xl my-2">Robert Renn</h1>
    ...
    <p>I started learning web development during the COVID lockdown.  I had experience with no-code application development, but decided to pursue the fundamental technology of the web.</p>
    <p className="my-4 font-bold">Links:</p>
    <ul className="flex flex-col p-4 max-w-24 justify-around border">
